...
![Panel de Control](images/doc10/doc10-panel-de-control-guebs.png)
    
Copia los datos de conexión:
   
![Datos de conexión SSH](images/doc10/doc10-panel-de-contro-datos-de-acceso-ssh.png)
...
![Conexión al servidor por ssh](images/doc10/doc10-conectarse-al-servidor-por-ssh.png)
...
![Clave pública y privada](images/doc10/doc10-claves-publica-y-privada.png)
